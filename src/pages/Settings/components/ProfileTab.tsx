...
import { useProfileTab } from './ProfileTab.hook.ts';

export function ProfileTab() {
  const { register, handleSubmit, errors, successMessage, onSubmit } = useProfileTab();
  ...
  return (
    <>
      ...
      <form
        ...
        className='flex flex-col lg:flex-row gap-2 lg:gap-8 lg:ml-8'
      >
        <ProfilePicture
          onImageChange={(file) => {
